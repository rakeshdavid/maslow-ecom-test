...
import * as sty from "./PlasmicMenuButton.module.css" // plasmic-import: UvrD2WmY7WXX/css

import BarsIcon from "./icons/PlasmicIcon__Bars" // plasmic-import: uIrh2t_47zpF/icon
import TimesIcon from "./icons/PlasmicIcon__Times" // plasmic-import: aRHuL35OeYHl/icon
    ...
    >
      ...
      >
        {(hasVariant(variants, "expanded", "expanded") ? false : true) ? (
          <BarsIcon
            className={classNames(defaultcss.all, sty.svg__kdYXc, {
              [sty.svg__expanded__kdYXcM9NG]: hasVariant(
                variants,
                "expanded",
                "expanded"
              ),
        ...
        {(hasVariant(variants, "expanded", "expanded") ? true : false) ? (
          <TimesIcon
            className={classNames(defaultcss.all, sty.svg__fxIio, {
              [sty.svg__expanded__fxIiom9NG]: hasVariant(
                variants,
                "expanded",
                "expanded"
              ),
