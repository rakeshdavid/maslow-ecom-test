...
import * as sty from "./PlasmicFeatureItem.module.css" // plasmic-import: muRQyL_XdUF/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.freeBox__vqW3P)}>
        <div className={classNames(defaultcss.all, sty.freeBox__r1BM)} />

        <div className={classNames(defaultcss.all, sty.freeBox__lkaYp)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox__kIfdd)}
          >
            <div
            ...
            <div className={classNames(defaultcss.all, sty.freeBox__fsXmq)}>
              <div
                className={classNames(
                  defaultcss.all,
                  defaultcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__fZjLf)}
            >
              <LinkButton
