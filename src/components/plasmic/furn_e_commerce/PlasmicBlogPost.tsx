...
import * as sty from "./PlasmicBlogPost.module.css" // plasmic-import: YUbDrbJ4zELA/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.freeBox__pRnqi, {
            [sty.freeBox__long__pRnqiKqLpw]: hasVariant(
              variants,
              "long",
              "long"
            ),
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <img
                alt={""}
                className={classNames(defaultcss.img, sty.img__xLc12)}
                src={b1HIB8WBllo9B}
              />
            ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__vX0Me, {
          [sty.freeBox__long__vX0MeKqLpw]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
